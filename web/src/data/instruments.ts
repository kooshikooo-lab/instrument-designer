...
export const INSTRUMENTS: Instrument[] = [
  ...
  },
  {
    ...
    difficulty: "Beginner",
    description: "Romanian/Ukrainian overtone flute, 30-100cm, bore 12-20mm. Simplest overtone flute type — no holes or 1 half-tone hole. Material: wood, reed, or PVC. Sound: simple, folk-like. Very easy to make — any hollow tube works. Key of G typical.",
  },
  {
  ...
  },
  {
    ...
    difficulty: "Beginner",
    description: "Modular overtone flute system by Nicolas Bras. 3D printed head (20mm or 25mm) + standard PVC pipe. Configurations: 1-hole semitone, 3-hole major, 6-hole chromatic. Head dimensions: 24x24x48mm, 9g. Friction fit to PVC pipe. Free STL/blueprints included. Also available as physical kit (€7-17).",
  },
  {
