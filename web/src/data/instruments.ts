...
export const INSTRUMENTS: Instrument[] = [
  ...
  },
  {
    ...
    audio_url: "",
    download_url: "",
    tags: ["advanced", "clarinet", "tmm-optimized", "bore-optimized", "chalumier", "design-engine"],
    difficulty: "Advanced",
    description: "TMM phase-resonance optimized Bb clarinet designed by the Chalumier engine. Uses transmission line modeling with JAX automatic differentiation for <3 cents RMS intonation. Bore profile and tone hole positions generated by evolutionary algorithm + L-BFGS-B optimizer.",
  },
  {
    ...
    audio_url: "",
    download_url: "",
    tags: ["advanced", "bass-clarinet", "tmm-optimized", "bore-optimized", "chalumier", "design-engine", "g-key"],
    difficulty: "Expert",
    description: "TMM phase-resonance optimized bass clarinet in G designed by the Chalumier engine. 24mm bore, low E range. Uses transmission line modeling for optimized intonation across the full range.",
  },
  {
    ...
    image_url: "",
    audio_url: "https://www.reddit.com/r/3dprintedinstruments/comments/iiuru2/my_3d_printed_chalumeau_pocket_clarinet_on/",
    download_url: "https://www.thingiverse.com/thing:3834802",
    tags: ["intermediate", "clarinet", "chalumeau", "pocket", "compact", "single-reed"],
    difficulty: "Intermediate",
    description: "Compact chalumeau-style pocket clarinet using a standard Bb clarinet mouthpiece. Played like a recorder, sounds surprisingly like a full-sized clarinet. Historical precursor to the modern clarinet, simplified for folk and practice use.",
  },
  {
    ...
    image_url: "",
    audio_url: "",
    download_url: "https://makerworld.com/en/more-models/clarinet-3d-print-model-download",
    tags: ["intermediate", "clarinet", "keyless", "folk", "simple", "beginner-friendly"],
    difficulty: "Intermediate",
    description: "Simplified keyless clarinet in Bb. Folk-style instrument with no metal keys, using cross-fingerings for chromatic notes. 159 boosts on MakerWorld. Good introduction to single-reed playing.",
  },
  {
    ...
    tags: ["advanced", "piccolo-clarinet", "a-clarinet", "simple-system", "9-keys", "fully-chromatic", "3d-printed"],
    difficulty: "Expert",
    description: "World's first print-at-home piccolo clarinet in A natural by JDWoodwinds. Simple system with 9 keys, fully chromatic range. Requires brass tubing, stainless steel rod, neoprene pads, springs, cork. Advanced project with significant post-processing.",
  },
  {
    ...
    image_url: "",
    audio_url: "https://www.youtube.com/watch?v=JQzPgg3jm50",
    download_url: "",
    tags: ["advanced", "baroque", "historical", "chalumeau", "2-key", "denner", "a-415", "early-music"],
    difficulty: "Advanced",
    description: "3D-printed 2-key baroque clarinet in the style of J.C. Denner (c.1700). Two keys: octave mechanism and front A. Tuned to A=415 Hz for historical performance practice. The earliest form of the clarinet, descended from the chalumeau. Historical instruments preserved in Bayerisches Nationalmuseum.",
  },
  {
  ...
  },
  {
    ...
    audio_url: "",
    download_url: "",
    tags: ["advanced", "double-reed", "classical", "conical", "ct-scan", "benchmark", "yamamoto-2025"],
    difficulty: "Advanced",
    description: "Classical oboe by Johann Andreas Lohner (Nürnberg, c.1800). CT-scanned and 3D-printed by Yamamoto et al. (2025). FDM replicas (PLA/woody-PLA) were indistinguishable from original in blind short-tone listening tests. Harmonic damping ratio error <0.2%. Bore: conical, ~62cm total length, Ø6mm at top expanding to Ø57mm at bell. NOTE: requires conical bore TMM support (not yet implemented).",
  },
  {
    ...
    audio_url: "",
    download_url: "",
    tags: ["advanced", "double-reed", "modern", "conical", "conservatory-keywork"],
    difficulty: "Advanced",
    description: "Modern conservatory-system oboe. Conical bore ~65cm, 25-34 keys. Key of C (soprano range Bb3-A6). Made of grenadilla wood or resin. The orchestral standard since the late 19th century. Tuning note A440 provided by oboist. NOTE: requires conical bore TMM support (not yet implemented).",
  },
  {
    ...
    audio_url: "",
    download_url: "",
    tags: ["advanced", "double-reed", "baroque", "historical", "conical", "2-3-keys", "cross-fingerings"],
    difficulty: "Advanced",
    description: "Baroque-era oboe (hautbois), 3 sections (top/bottom/bell), 2-3 keys, cross-fingerings for chromatic notes. Narrower bore than modern oboe, softer/darker tone. Range c1-d3 (~2.5 octaves). Modern copies exist from museum CT scans. Staple: 63mm, bottom Ø5.5mm. Reed: 88mm total. NOTE: requires conical bore TMM support (not yet implemented).",
  },
  {
  ...
  },
  {
    ...
    tags: ["beginner", "kazoo", "mirliton", "membrane", "fun"],
    difficulty: "Beginner",
    description: "Classic kazoo — a mirliton (membranophone). Hum into it to produce a buzzing tone through the vibrating membrane.",
  },
  {
  ...
  },
  {
    ...
    source: "YouTube",
    image_url: "",
    audio_url: "https://www.youtube.com/watch?v=UwhckKENDoU",
    download_url: "",
    tags: ["expert", "pvc", "contrabass", "clarinet", "experimental", "adjustable"],
    difficulty: "Expert",
    description: "PVC contrabass clarinet by Arrington de Dionyso. Can be adjusted while playing for microtonal effects. Not 3D-printable, but pitch can be calculated from bore length using our software.",
  },
  {
