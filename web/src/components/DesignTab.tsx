...
import { checkHealth, startDesign, getDesignStatus, getDesignDownloadUrl, exportStep, startOptimization, getOptimizationStatus, getOptimizationPresets, getCacheStats, clearCache, exportBoreSvg, downloadSvg, exportCadquery, listCadqueryInstruments } from "../utils/api";
            ...
            <div className="flex gap-2">
              ...
              {serverBlob && (
                <button
                  onClick={async () => {
                    try {
                      const res = await fetch(await getDesignDownloadUrl(jobId!));
                      const blob = await res.blob();
