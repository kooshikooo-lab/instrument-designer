...
> Local copy of the wiki page `wiki/Internal-CT-Scanned-Instruments.md` for quick
> reference. Canonical version lives in the wiki. Sources verified 2026-07-31.
