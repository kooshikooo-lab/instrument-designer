"""Test: uniform 14mm holes vs 11mm on 12-hole chromatic."""
...
for hole_dia, label in [(11.0, "11mm uniform"), (14.0, "14mm uniform"), (16.0, "16mm uniform")]:
    print(f"\n=== {label} ===")
    t0 = time.time()
    ...
    t1 = time.time()
    print(f"  Time: {t1-t0:.0f}s, RMS={result['final_rms_cents']:.2f}c")
