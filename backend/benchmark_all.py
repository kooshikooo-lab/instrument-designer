...
INSTRUMENTS = {
    ...
    "clarinet_Bb": {
        ...
        "closed_top": True,
        "targets": [130.81, 138.59, 146.83, 155.56, 164.81, 174.61, 185.00, 196.00,
                     207.65, 220.00, 233.08, 246.94, 261.63, 277.18, 293.66, 311.13,
                     329.63, 349.23, 369.99, 392.00, 415.30, 440.00, 466.16, 493.88, 523.25],
        "names": ["C3", "D3", "Eb3", "E3", "F3", "F#3", "G3", "Ab3", "A3", "Bb3", "B3",
                   "C4", "C#4", "D4", "Eb4", "E4", "F4", "F#4", "G4", "Ab4", "A4", "Bb4", "B4", "C5", "C#5"],
        "bore_radius": 7.25, "outer_diameter": 22.0,
        "hole_diameter": 6.93, "hole_length": 3.75,
        "hole_positions": [61.08, 103.68, 153.12, 198.71, 237.04, 277.63, 318.47, 355.60,
                            391.00, 424.07, 456.57, 495.08, 535.59, 582.88, 626.76, 667.02, 710.15],
        "hole_diameters": [6.93, 6.12, 6.22, 6.31, 6.65, 6.03, 6.15, 6.5, 6.5, 6.5, 6.5, 6.5, 6.5, 6.5, 6.5, 6.5, 6.5],
        "hole_lengths": [3.75, 3.75, 3.75, 3.75, 3.75, 3.75, 3.75, 3.75, 3.75, 3.75, 3.75, 3.75, 3.75, 3.75, 3.75, 3.75, 3.75],
        "fingerings": [
            ["closed"] * 17,
            ["open"] + ["closed"] * 16,
            ["closed", "open"] + ["closed"] * 15,
            ["closed"] * 2 + ["open"] + ["closed"] * 14,
            ["closed"] * 3 + ["open"] + ["closed"] * 13,
            ["closed"] * 4 + ["open"] + ["closed"] * 12,
            ["closed"] * 5 + ["open"] + ["closed"] * 11,
            ["closed"] * 6 + ["open"] + ["closed"] * 10,
            ["closed"] * 7 + ["open"] + ["closed"] * 9,
            ["closed"] * 8 + ["open"] + ["closed"] * 8,
            ["closed"] * 9 + ["open"] + ["closed"] * 7,
            ["closed"] * 10 + ["open"] + ["closed"] * 6,
            ["closed"] * 11 + ["open"] + ["closed"] * 5,
            ["closed"] * 12 + ["open"] + ["closed"] * 4,
            ["closed"] * 13 + ["open"] + ["closed"] * 3,
            ["closed"] * 14 + ["open"] + ["closed"] * 2,
            ["closed"] * 15 + ["open"] + ["closed"] * 1,
            ["closed"] * 16 + ["open"],
            ["closed"] * 7 + ["open"] + ["closed"] * 3 + ["open", "open", "open"] + ["closed"] * 3,
            ["closed"] * 7 + ["open"] + ["closed"] * 3 + ["open", "open", "open"] + ["closed"] * 3,
            ["closed"] * 7 + ["open"] + ["closed"] * 3 + ["open", "open", "open"] + ["closed"] * 3,
            ["closed"] * 7 + ["open"] + ["closed"] * 3 + ["open", "open", "open"] + ["closed"] * 3,
            ["closed"] * 7 + ["open"] + ["closed"] * 3 + ["open", "open", "open"] + ["closed"] * 3,
