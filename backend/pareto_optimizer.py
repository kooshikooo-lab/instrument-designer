...
Usage
-----
    from backend.pareto_optimizer import nsga2_minimize, pareto_sweep, run_pareto
    from backend.benchmark_all import INSTRUMENTS

    # Single-objective (timbre matching, etc.)
    result = nsga2_minimize(cost_fn, n_var=6, xl=xl, xu=xu)
...
# ============================================================================
# Single-objective NSGA-II wrapper
# ============================================================================
...
def nsga2_minimize(
    ...
    """Single-objective NSGA-II minimization.
