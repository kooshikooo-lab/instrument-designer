...
# QUARANTINED 2026-07-31: references backend.archived_optimizers.bore_optimizer,
# deleted from backend/archived_optimizers (docs/ARCHIVED_OPTIMIZERS.md).
# Superseded by backend/optimizer.py (restored NSGA-II with PAVA monotonicity repair).
try:
    from backend.optimizer import BoreOptimizer  # noqa: F401
except ModuleNotFoundError:
    raise SystemExit(
        "ARCHIVED: BoreOptimizer was deleted on 2026-07-31 "
        "(see docs/ARCHIVED_OPTIMIZERS.md). Superseded by backend/optimizer.py."
    )
